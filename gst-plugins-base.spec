...
Source0  : https://gstreamer.freedesktop.org/src/gst-plugins-base/gst-plugins-base-1.9.1.tar.xz
...
%prep
%setup -q -n gst-plugins-base-1.9.1
...
/usr/share/gir-1.0/GstFft-1.0.gir
